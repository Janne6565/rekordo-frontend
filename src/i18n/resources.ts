const enCommon = {
  ...
  friends: {
    ...
    results: "Results",
    /* 1a: the desktop search's popover under the field; 2a: the phone's Find tab. */
    search: {
      results: "Results · {{count}}",
      searching: "Searching",
      esc: "Esc",
      hint: "↑ ↓ move · Enter opens the shelf · Esc closes",
      clear: "Clear search",
      comeBack: "Requests and People come back when you clear the search.",
    },
    people: "People · {{count}}",
  ...
  auth: {
    ...
    agreeTerms:
      "I accept the <terms>Nutzungsbedingungen</terms>, have read the <privacy>Datenschutzerklärung</privacy>, and am 16 or older.",
    providerNeedsConsent: "Available once the box above is ticked.",
    showPassword: "Show password",
    hidePassword: "Hide password",
    passwordHint: "Ten characters minimum. A passphrase beats a password.",
    passwordHintShort: "Ten characters minimum",
    ...
    continueWithoutBody: "Saved in this browser only.",
    signOut: "Sign out",
...
const deCommon: CommonSchema = {
  ...
  friends: {
    ...
    search: {
      ...
      esc: "Esc",
      hint: "↑ ↓ wählen · Enter öffnet das Regal · Esc schließt",
      clear: "Suche leeren",
      comeBack: "Anfragen und Leute kommen zurück, sobald du die Suche leerst.",
    },
    people: "Leute · {{count}}",
  ...
  auth: {
    ...
    agreeTerms:
      "Ich akzeptiere die <terms>Nutzungsbedingungen</terms>, habe die <privacy>Datenschutzerklärung</privacy> gelesen und bin 16 Jahre oder älter.",
    providerNeedsConsent: "Verfügbar, sobald das Häkchen oben gesetzt ist.",
    showPassword: "Passwort anzeigen",
    hidePassword: "Passwort verbergen",
    passwordHint: "Mindestens zehn Zeichen. Eine Passphrase schlägt ein Passwort.",
    passwordHintShort: "Mindestens zehn Zeichen",
    ...
    continueWithoutBody: "Nur in diesem Browser gespeichert.",
    signOut: "Abmelden",
